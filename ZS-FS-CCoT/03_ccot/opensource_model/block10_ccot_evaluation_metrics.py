# ══════════════════════════════════════════════════════════════
# BLOCK 10 — Evaluation Metrics (same schema as other runs)
# ══════════════════════════════════════════════════════════════
import pandas as pd
...
# Dominant-Meaning Bias — the central metric
...
# chrF + BERTScore on the raw reasoning vs gold explanation
chrf       = CHRF()
...
print("══════════════════════════════════════════════")
print(f"  RESULTS — {MODEL_PATH}   C-CoT")
print("══════════════════════════════════════════════")
...
print(f"  Dominant-Bias %    : {bias_rate:.1f}%   ← KEY NUMBER")
print(f"\n── Per-Category ───────────────────────────────")
